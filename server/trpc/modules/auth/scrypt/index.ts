// Reference: https://github.com/pilcrowOnPaper/lucia/blob/main/packages/lucia/src/scrypt/index.ts
...
function XorAndSalsa(prev: Uint32Array,
  pi: number,
  input: Uint32Array,
  ii: number,
  out: Uint32Array,
...
function BlockMix(input: Uint32Array,
  ii: number,
  out: Uint32Array,
  oi: number,
  r: number) {
...
async function scryptInit(password: Uint8Array,
  salt: Uint8Array,
  _opts?: ScryptOpts) {
